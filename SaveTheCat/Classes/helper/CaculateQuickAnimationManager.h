...
#define ANIMATION_MANAGER CaculateQuickAnimationManager::GetInstance()

class CaculateQuickAnimationManager : public BaseSingleton<CaculateQuickAnimationManager>
{
