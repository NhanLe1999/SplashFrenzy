...
CaculateQuickAnimationManager::CaculateQuickAnimationManager()
{
	init();
}
...
bool CaculateQuickAnimationManager::init()
{
...
void CaculateQuickAnimationManager::zoomInEffect(Node * i_node, std::function<void()> i_callback)
{
...
void CaculateQuickAnimationManager::zoomOutEffect(Node * i_node, std::function<void()> i_callback)
{
	MK_RETURN_IF_WITH_CONTENT(i_node == nullptr, , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::fadeInEffect(Node * i_node,std::function<void()> i_callback, float duration)
{
	MK_RETURN_IF_WITH_CONTENT(i_node == nullptr, , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::fadeInEffect(std::vector<Node*> i_nodes, std::function<void()> i_callback, float duration)
{
...
void CaculateQuickAnimationManager::moveLeftEffect(Node * i_node, std::function<void()> i_callback, float duration)
{
	MK_RETURN_IF_WITH_CONTENT(i_node == nullptr, , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::zoomInZoomOutEffect(Node * i_node, std::function<void()> i_callback, float duration)
{
	MK_RETURN_IF_WITH_CONTENT(i_node == nullptr, , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::zoomInZoomOutEffect(std::vector<Node*> i_nodes, std::function<void()> i_callback, float duration)
{
	MK_RETURN_IF_WITH_CONTENT(i_nodes.empty(), , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::fadeInAndZoomInEffectForNodes(std::vector<Node*> i_nodes , float fadeInZommInDuration , float fadeInDurationBetweenItems , std::function<void()> i_callback)
{
	MK_RETURN_IF_WITH_CONTENT(i_nodes.empty(), , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::transitionSlideIn(Direction i_direction, float i_duration, std::vector<Node*> i_nodes, std::function<void()> i_callback)
{
	for (int i = 0; i < i_nodes.size(); i++) {
...
void CaculateQuickAnimationManager::transitionSlideIn(Direction i_direction, float i_duration, std::vector<std::pair<std::vector<Node*>, float>> i_nodesAndDelaytime, std::function<void()> i_callback)
{
    ...
    for (int i = 0; i <i_nodesAndDelaytime.size();i++ ) {
        ...
        for (int j = 0; j < info.first.size(); j++) {
            ...
            if(auto node = info.first.at(j)) {
                ...
                switch (i_direction)
                {
                case CaculateQuickAnimationManager::Direction::LEFT:
                        node->setPositionX(k_currentPosition.x + _screenSize.width);
                    break;
                case CaculateQuickAnimationManager::Direction::RIGHT:
                        node->setPositionX(k_currentPosition.x - _screenSize.width);
                    break;
                case CaculateQuickAnimationManager::Direction::TOP:
                        node->setPositionY(k_currentPosition.y - _screenSize.height);
                    break;
                case CaculateQuickAnimationManager::Direction::BOTTOM:
                        node->setPositionY(k_currentPosition.y + _screenSize.height);
                    break;
                default:
                    break;
...
void CaculateQuickAnimationManager::transitionSlideIn(Direction i_direction, float i_duration, Node * i_node, std::function<void()> i_callback)
{
	MK_RETURN_IF_WITH_CONTENT(i_node == nullptr, , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::transitionSlideOut(Direction i_direction, float i_duration, std::vector<Node*> i_nodes, std::function<void()> i_callback)
{
	for (int i = 0; i < i_nodes.size(); i++) {
...
void CaculateQuickAnimationManager::transitionSlideOut(Direction i_direction, float i_duration, std::vector<std::pair<std::vector<Node*>, float>> i_nodesAndDelaytime, std::function<void()> i_callback)
{
    MK_RETURN_IF_WITH_CONTENT( i_nodesAndDelaytime.empty(), ,if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::transitionSlideOut(Direction i_direction, float i_duration, Node * i_node, std::function<void()> i_callback)
{
	MK_RETURN_IF_WITH_CONTENT(i_node == nullptr, , if (i_callback) i_callback(););
...
void CaculateQuickAnimationManager::popupCustomAnimation(cocos2d::Node* popupBackground,  ActionType actionType, float actionTime, std::function<void()> callback ) {
...
Animation* CaculateQuickAnimationManager::createAnimation(const char* prefixName, int start, int end, float delay, std::string lastFrame)
{
...
cocos2d::Animation * CaculateQuickAnimationManager::createAnimationWithLoop(const char * prefixName, int start, int end, float delay)
{
	Vector<SpriteFrame*> animFrames;
...
Animation* CaculateQuickAnimationManager::createAnimation(const char* prefixName, int start, int end, float delay, int loop )
{
	Vector<SpriteFrame*> animFrames;
